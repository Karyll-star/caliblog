...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://karyll.so/favicons/zolplay.png',
  '(?:github.com)': 'https://karyll.so/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://karyll.so/favicons/twitter.png',
  'coolshell.cn': 'https://karyll.so/favicons/coolshell.png',
  'vercel.com': 'https://karyll.so/favicons/vercel.png',
  'nextjs.org': 'https://karyll.so/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://karyll.so/favicon_blank.png'
