          ...
          <Container className="mx-auto mt-[32px] w-[465px]">
            ...
            <Section>
              ...
              <Text className="text-center">
                <Link
                  href="https://karyll.so"
                  className="text-zinc-700 underline"
                >
                  <strong>Karyll Castle</strong>
                </Link>
                <br />
                开发者、设计师、细节控、创始人
              </Text>
